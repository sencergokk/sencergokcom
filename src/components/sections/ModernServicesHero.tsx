    ...
    <section className="relative min-h-[80vh] overflow-hidden pt-32">
      ...
      <div className="relative z-10 container mx-auto px-4 min-h-[80vh] flex items-center">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button 
            size="lg"
            className="group relative overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-10 md:px-12 py-6 md:py-8 text-lg md:text-xl font-bold rounded-2xl h-auto border-0 shadow-2xl hover:shadow-blue-500/25 transition-all duration-300"
          >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-16">
            <div className="text-center">
              ...
              <div className="text-xs md:text-sm text-gray-400">Ana Hizmet</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-black text-white mb-2">50+</div>
              <div className="text-xs md:text-sm text-gray-400">Alt Kategoriler</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-black text-white mb-2">100%</div>
              <div className="text-xs md:text-sm text-gray-400">Özelleştirilebilir</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-black text-white mb-2">24/7</div>
              <div className="text-xs md:text-sm text-gray-400">Destek</div>
            </div>
          </div>
        </div>
      </div>
